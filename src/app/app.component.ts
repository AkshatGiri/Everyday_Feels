...
export class MyApp {
  ...
  rootPage: string = 'AfterLoginPage';
  menu:Array<any> = [];
  pages: Array<any>;

  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, private auth: AuthData) {
    this.initializeApp();
    ...
    this.pages = [ 
      ...
      { icon: 'logo-buffer', title:"Data", component: "ChartPage"},
    ];
